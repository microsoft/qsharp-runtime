...
public:
    ...
    virtual bool dump_qubits(std::vector<logical_qubit_id> const& qubits, void (*callback)(unsigned, double, double)) = 0;

    virtual void dump_all(logical_qubit_id max_qubit_id, void (*callback)(unsigned, double, double)) = 0;
