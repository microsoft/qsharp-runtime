...
class IQuantumProcessor
{
    ...
    /// <param name="qubit">Qubit to which the gate should be applied.</param>
    void ControlledX(long numQubits, Qubit* controls, Qubit qubit);
    ...
    /// <param name="controls">The array of qubits on which the operation is controlled.</param>
    /// <param name="qubit">Qubit to which the gate should be applied.</param>
    void ControlledY(long numQubits, Qubit* controls, Qubit qubit);
    ...
    /// <param name="controls">The array of qubits on which the operation is controlled.</param>
    /// <param name="qubit">Qubit to which the gate should be applied.</param>
    void ControlledZ(long numQubits, Qubit* controls, Qubit qubit);
    ...
    /// <param name="qubit1">First qubit to be swapped.</param>
    /// <param name="qubit2">Second qubit to be swapped.</param>
    void ControlledSWAP(long numQubits, Qubit* controls, Qubit qubit1, Qubit qubit2);
    ...
    /// <param name="controls">The array of qubits on which the operation is controlled.</param>
    /// <param name="qubit">Qubit to which the gate should be applied.</param>
    void ControlledH(long numQubits, Qubit* controls, Qubit qubit);
    ...
    /// <param name="controls">The array of qubits on which the operation is controlled.</param>
    /// <param name="qubit">Qubit to which the gate should be applied.</param>
    void ControlledS(long numQubits, Qubit* controls, Qubit qubit);
    ...
    /// <param name="controls">The array of qubits on which the operation is controlled.</param>
    /// <param name="qubit">Qubit to which the gate should be applied.</param>
    void ControlledSAdjoint(long numQubits, Qubit* controls, Qubit qubit);
    ...
    /// <param name="controls">The array of qubits on which the operation is controlled.</param>
    /// <param name="qubit">Qubit to which the gate should be applied.</param>
    void ControlledT(long numQubits, Qubit* controls, Qubit qubit);
    ...
    /// <param name="controls">The array of qubits on which the operation is controlled.</param>
    /// <param name="qubit">Qubit to which the gate should be applied.</param>
    void ControlledTAdjoint(long numQubits, Qubit* controls, Qubit qubit);
    ...
    /// <param name="qubit">Qubit to which the gate should be applied.</param>
    void R(PauliId axis, double theta, Qubit qubit);
    ...
    /// <param name="theta">Angle about which the qubit is to be rotated.</param>
    /// <param name="qubit">Qubit to which the gate should be applied.</param>
    void ControlledR(long numQubits, Qubit* controls, PauliId axis, double theta, Qubit qubit);
    ...
    /// <param name="qubit">Qubit to which the gate should be applied.</param>
    void RFrac(PauliId axis, long numerator, long power, Qubit qubit);
    ...
    /// <param name="power">Power of two specifying the denominator of the angle by which the qubit is to be rotated.</param>
    /// <param name="qubit">Qubit to which the gate should be applied.</param>
    void ControlledRFrac(long numQubits, Qubit* controls, PauliId axis, long numerator, long power, Qubit qubit);
    ...
    /// <param name="theta">Angle about which the qubit is to be rotated.</param>
    /// <param name="qubit">Qubit to which the gate should be applied.</param>
    void ControlledR1(long numQubits, Qubit* controls, double theta, Qubit qubit);
    ...
    /// <param name="power">Power of two specifying the denominator of the angle by which the qubit is to be rotated.</param>
    /// <param name="qubit">Qubit to which the gate should be applied.</param>
    void ControlledR1Frac(long numQubits, Qubit* controls, long numerator, long power, Qubit qubit);
    ...
    void Exp(long numQubits, PauliId* paulis, double theta, Qubit* qubits); // !!! same numQubits?
    ...
    /// <param name="theta">Angle about the given multi-qubit Pauli operator by which the target register is to be rotated.</param>
    /// <param name="qubits">Register to apply the exponent to.</param>
    void ControlledExp(long numControls, Qubit* controls, long numQubits, PauliId* paulis, double theta, Qubit* qubits);
    ...
    /// <param name="qubits">Register to apply the exponent to.</param>
    void ExpFrac(long numQubits, PauliId* paulis, long numerator, long power, Qubit* qubits);
    ...
    /// <param name="power">Power of two specifying the denominator of the angle by which the qubit register is to be rotated.</param>
    /// <param name="qubits">Register to apply the exponent to.</param>
    void ControlledExpFrac(long numControls, Qubit* controls, long numQubits, PauliId* paulis, long numerator, long power, Qubit* qubits);
    ...
    /// <returns> Zero if the +1 eigenvalue is observed, and One if the -1 eigenvalue is observed.</returns>
    Result Measure(long numQubits, PauliId* bases, Qubit* qubits);
...
*/
    ...
    void Assert(long numQubits, PauliId* bases, Qubit* qubits, ResultValue result, string msg); // !!! ResultValue???
    ...
    void AssertProb(long numQubits, PauliId* bases, Qubit* qubits, double probabilityOfZero, string msg, double tol);
/*
    /// <summary>
...
*/
    ...
    /// </remarks>
    void OnAllocateQubits(long numQubits, Qubit* qubits);
    ...
    /// </remarks>
    void OnReleaseQubits(long numQubits, Qubit* qubits);
    ...
    /// </remarks>
    void OnBorrowQubits(long numQubits, Qubit* qubits, long allocatedForBorrowingCount);
    ...
    /// </remarks>
    void OnReturnQubits(long numQubits, Qubit* qubits, long releasedOnReturnCount);
/*
    /// <summary>
    /// Called when 
