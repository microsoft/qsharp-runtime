...
namespace Microsoft.Quantum.Simulation.Simulators.NewTracer.OldDecomposition
{
    internal partial class OldTracerInternalSim
    {
        ...
        {
            private OldTracerInternalSim tracerCore { get; }

            public TracerApplyIfElse(OldTracerInternalSim m) : base(m)
            {
                this.tracerCore = m;
            }
        ...
        public class TracerApplyIfElseA : Interface_ApplyIfElseA
        {
            ...
            public TracerApplyIfElseA(OldTracerInternalSim m) : base(m)
            {
                this.tracerCore = m;
            }
        ...
        public class TracerApplyIfElseC : Interface_ApplyIfElseC
        {
            ...
            public TracerApplyIfElseC(OldTracerInternalSim m) : base(m)
            {
                this.tracerCore = m;
            }
        ...
        public class TracerApplyIfElseCA : Interface_ApplyIfElseCA
        {
            ...
            public TracerApplyIfElseCA(OldTracerInternalSim m) : base(m)
            {
                this.tracerCore = m;
            }
        ...
        public class TracerApplyConditionally : Interface_ApplyConditionally
        {
            ...
            public TracerApplyConditionally(OldTracerInternalSim m) : base(m)
            {
                this.tracerCore = m;
            }
        ...
        public class TracerApplyConditionallyA : Interface_ApplyConditionallyA
        {
            ...
            public TracerApplyConditionallyA(OldTracerInternalSim m) : base(m)
            {
                this.tracerCore = m;
            }
        ...
        public class TracerApplyConditionallyC : Interface_ApplyConditionallyC
        {
            ...
            public TracerApplyConditionallyC(OldTracerInternalSim m) : base(m)
            {
                this.tracerCore = m;
            }
        ...
        public class TracerApplyConditionallyCA : Interface_ApplyConditionallyCA
        {
            ...
            public TracerApplyConditionallyCA(OldTracerInternalSim m) : base(m)
            {
                this.tracerCore = m;
            }
