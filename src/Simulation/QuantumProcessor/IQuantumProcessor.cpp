...
#include <stdio.h>
#include <stdlib.h>
#include <IQuantumProcessor.h>

//#define EXPORTLAPI extern "C" __declspec(dllexport) 

//#ifdef EXPORTINGDI
//#  define EXPORTDI __declspec(dllexport)
//#else
//#  define EXPORTDI __declspec(dllimport)
//#endif
...
void IQuantumProcessor::X(Qubit qubit) {}
...
/// <param name="qubit">Qubit to which the gate should be applied.</param>
void IQuantumProcessor::ControlledX(long numQubits, Qubit* controls, Qubit qubit) {}
...
/// </remarks>
/// <param name="qubit">Qubit to which the gate should be applied.</param>
void IQuantumProcessor::Y(Qubit qubit) {}
...
/// <param name="controls">The array of qubits on which the operation is controlled.</param>
/// <param name="qubit">Qubit to which the gate should be applied.</param>
void IQuantumProcessor::ControlledY(long numQubits, Qubit* controls, Qubit qubit) {}
...
/// </remarks>
/// <param name="qubit">Qubit to which the gate should be applied.</param>
void IQuantumProcessor::Z(Qubit qubit) {}
...
/// <param name="controls">The array of qubits on which the operation is controlled.</param>
/// <param name="qubit">Qubit to which the gate should be applied.</param>
void IQuantumProcessor::ControlledZ(long numQubits, Qubit* controls, Qubit qubit) {}
...
void IQuantumProcessor::SWAP(Qubit qubit1, Qubit qubit2) {}
...
/// <param name="qubit1">First qubit to be swapped.</param>
/// <param name="qubit2">Second qubit to be swapped.</param>
void IQuantumProcessor::ControlledSWAP(long numQubits, Qubit* controls, Qubit qubit1, Qubit qubit2) {}
...
/// </remarks>
/// <param name="qubit">Qubit to which the gate should be applied.</param>
void IQuantumProcessor::H(Qubit qubit) {}
...
/// <param name="controls">The array of qubits on which the operation is controlled.</param>
/// <param name="qubit">Qubit to which the gate should be applied.</param>
void IQuantumProcessor::ControlledH(long numQubits, Qubit* controls, Qubit qubit) {}
...
/// </remarks>
/// <param name="qubit">Qubit to which the gate should be applied.</param>
void IQuantumProcessor::S(Qubit qubit) {}
...
/// <param name="controls">The array of qubits on which the operation is controlled.</param>
/// <param name="qubit">Qubit to which the gate should be applied.</param>
void IQuantumProcessor::ControlledS(long numQubits, Qubit* controls, Qubit qubit) {}
...
/// </remarks>
/// <param name="qubit">Qubit to which the gate should be applied.</param>
void IQuantumProcessor::SAdjoint(Qubit qubit) {}
...
/// <param name="controls">The array of qubits on which the operation is controlled.</param>
/// <param name="qubit">Qubit to which the gate should be applied.</param>
void IQuantumProcessor::ControlledSAdjoint(long numQubits, Qubit* controls, Qubit qubit) {}
...
/// </remarks>
/// <param name="qubit">Qubit to which the gate should be applied.</param>
void IQuantumProcessor::T(Qubit qubit) {}
...
/// <param name="controls">The array of qubits on which the operation is controlled.</param>
/// <param name="qubit">Qubit to which the gate should be applied.</param>
void IQuantumProcessor::ControlledT(long numQubits, Qubit* controls, Qubit qubit) {}
...
/// </remarks>
/// <param name="qubit">Qubit to which the gate should be applied.</param>
void IQuantumProcessor::TAdjoint(Qubit qubit) {}
...
/// <param name="controls">The array of qubits on which the operation is controlled.</param>
/// <param name="qubit">Qubit to which the gate should be applied.</param>
void IQuantumProcessor::ControlledTAdjoint(long numQubits, Qubit* controls, Qubit qubit) {}
...
/// <param name="qubit">Qubit to which the gate should be applied.</param>
void IQuantumProcessor::R(PauliId axis, double theta, Qubit qubit) {}
...
/// <param name="theta">Angle about which the qubit is to be rotated.</param>
/// <param name="qubit">Qubit to which the gate should be applied.</param>
void IQuantumProcessor::ControlledR(long numQubits, Qubit* controls, PauliId axis, double theta, Qubit qubit) {}
...
/// <param name="qubit">Qubit to which the gate should be applied.</param>
void IQuantumProcessor::RFrac(PauliId axis, long numerator, long power, Qubit qubit) {}
...
/// <param name="power">Power of two specifying the denominator of the angle by which the qubit is to be rotated.</param>
/// <param name="qubit">Qubit to which the gate should be applied.</param>
void IQuantumProcessor::ControlledRFrac(long numQubits, Qubit* controls, PauliId axis, long numerator, long power, Qubit qubit) {}
...
/// <param name="theta">Angle about which the qubit is to be rotated.</param>
/// <param name="qubit">Qubit to which the gate should be applied.</param>
void IQuantumProcessor::R1(double theta, Qubit qubit) {}
...
/// <param name="theta">Angle about which the qubit is to be rotated.</param>
/// <param name="qubit">Qubit to which the gate should be applied.</param>
void IQuantumProcessor::ControlledR1(long numQubits, Qubit* controls, double theta, Qubit qubit) {}
...
/// <param name="power">Power of two specifying the denominator of the angle by which the qubit is to be rotated.</param>
/// <param name="qubit">Qubit to which the gate should be applied.</param>
void IQuantumProcessor::R1Frac(long numerator, long power, Qubit qubit) {}
...
/// <param name="power">Power of two specifying the denominator of the angle by which the qubit is to be rotated.</param>
/// <param name="qubit">Qubit to which the gate should be applied.</param>
void IQuantumProcessor::ControlledR1Frac(long numQubits, Qubit* controls, long numerator, long power, Qubit qubit) {}
...
void IQuantumProcessor::Exp(long numQubits, PauliId* paulis, double theta, Qubit* qubits) {} // !!! same numQubits?
...
/// <param name="theta">Angle about the given multi-qubit Pauli operator by which the target register is to be rotated.</param>
/// <param name="qubits">Register to apply the exponent to.</param>
void IQuantumProcessor::ControlledExp(long numControls, Qubit* controls, long numQubits, PauliId* paulis, double theta, Qubit* qubits) {}
...
/// <param name="qubits">Register to apply the exponent to.</param>
void IQuantumProcessor::ExpFrac(long numQubits, PauliId* paulis, long numerator, long power, Qubit* qubits) {}
...
/// <param name="power">Power of two specifying the denominator of the angle by which the qubit register is to be rotated.</param>
/// <param name="qubits">Register to apply the exponent to.</param>
void IQuantumProcessor::ControlledExpFrac(long numControls, Qubit* controls, long numQubits, PauliId* paulis, long numerator, long power, Qubit* qubits) {}
...
Result IQuantumProcessor::M(Qubit qubit) { return Result_Zero; }
...
/// <returns> Zero if the +1 eigenvalue is observed, and One if the -1 eigenvalue is observed.</returns>
Result IQuantumProcessor::Measure(long numQubits, PauliId* bases, Qubit* qubits) { return Result_Zero; }
...
/// </remarks>
/// <param name="qubit">Qubit to which the gate should be applied.</param>
void IQuantumProcessor::Reset(Qubit qubit) {}
/*
/// <summary>
...
/// </remarks>
long StartConditionalStatement(long numResults, Result* measurementResults, Result* resultsValues) {}
...
void IQuantumProcessor::Assert(long numQubits, PauliId* bases, Qubit* qubits, ResultValue result, string msg) {} // !!! ResultValue???
...
void IQuantumProcessor::AssertProb(long numQubits, PauliId* bases, Qubit* qubits, double probabilityOfZero, string msg, double tol) {}
/*
/// <summary>
...
/// </remarks>
void IQuantumProcessor::OnAllocateQubits(long numQubits, Qubit* qubits) {}
...
/// </remarks>
void IQuantumProcessor::OnReleaseQubits(long numQubits, Qubit* qubits) {}
...
/// </remarks>
void IQuantumProcessor::OnBorrowQubits(long numQubits, Qubit* qubits, long allocatedForBorrowingCount) {}
...
/// </remarks>
void IQuantumProcessor::OnReturnQubits(long numQubits, Qubit* qubits, long releasedOnReturnCount) {}
/*
/// <summary>
/// Called when 
