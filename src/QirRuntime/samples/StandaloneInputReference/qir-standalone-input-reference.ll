...
@5 = internal constant [13 x i8] c"rangeValue: \00"

@Quantum__StandaloneSupportedInputs__ExerciseInputs = alias i64 (i64, double, %Result*, %String*, %Range), i64 (i64, double, %Result*, %String*, %Range)* @Quantum__StandaloneSupportedInputs__ExerciseInputs__body

define i64 @Quantum__StandaloneSupportedInputs__ExerciseInputs__body(i64 %intValue, double %doubleValue, %Result* %resultValue, %String* %stringValue, %Range %rangeValue) #0 {
entry:
  ...
  %7 = call %String* @__quantum__rt__string_create(i32 12, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @5, i32 0, i32 0))
  %8 = call %String* @__quantum__rt__range_to_string(%Range %rangeValue)
  %msg__5 = call %String* @__quantum__rt__string_concatenate(%String* %7, %String* %8)
  ...
  call void @__quantum__qis__message__body(%String* %msg__5)
  call void @__quantum__rt__string_update_reference_count(%String* %msg__5, i64 -1)
  ret i64 0
}
