...
;Constants - might conflict if they are defined in multiple LL files.
...
@Microsoft_Quantum_Samples_Chemistry_SimpleVQE_GetEnergyHydrogenVQE = alias double (double, double, double, i64), double (double, double, double, i64)* @Microsoft__Quantum__Samples__Chemistry__SimpleVQE__GetEnergyHydrogenVQE__body
...
;entrypoint, can invoke this from native. C-compatible signature.
...
entry:
  ...
  %128 = getelementptr { %TupleHeader, i64, %Array* }, { %TupleHeader, i64, %Array* }* %inputState, i64 0, i32 1
  store i64 3, i64* %128
  ...
  %133 = getelementptr { %TupleHeader, double, double }, { %TupleHeader, double, double }* %132, i64 0, i32 1
  store double %theta1, double* %133
  %134 = getelementptr { %TupleHeader, double, double }, { %TupleHeader, double, double }* %132, i64 0, i32 2
  ...
  %145 = getelementptr { %TupleHeader, double, double }, { %TupleHeader, double, double }* %144, i64 0, i32 1
  store double %theta2, double* %145
  %146 = getelementptr { %TupleHeader, double, double }, { %TupleHeader, double, double }* %144, i64 0, i32 2
  ...
  %157 = getelementptr { %TupleHeader, double, double }, { %TupleHeader, double, double }* %156, i64 0, i32 1
  store double %theta3, double* %157
  %158 = getelementptr { %TupleHeader, double, double }, { %TupleHeader, double, double }* %156, i64 0, i32 2
  ...
  %173 = getelementptr { %TupleHeader, double, double }, { %TupleHeader, double, double }* %172, i64 0, i32 1
  store double 1.000000e+00, double* %173
  %174 = getelementptr { %TupleHeader, double, double }, { %TupleHeader, double, double }* %172, i64 0, i32 2
  ...
  %182 = getelementptr { %TupleHeader, i64, %Array* }, { %TupleHeader, i64, %Array* }* %inputState, i64 0, i32 2
  ...
  %183 = call double @Microsoft__Quantum__Samples__Chemistry__SimpleVQE__VariationalQuantumEigensolver__EstimateEnergy__body(i64 5, { %TupleHeader, %Array*, %Array*, %Array*, %Array* }* %hamiltonian, { %TupleHeader, i64, %Array* }* %inputState, double 0xBFB94D36D949CC98, i64 %nSamples)
...
entry:
  ...
  %2 = getelementptr { %TupleHeader, %Array*, %Array*, %Array*, %Array* }, { %TupleHeader, %Array*, %Array*, %Array*, %Array* }* %1, i64 0, i32 1
  store %Array* %arg0, %Array** %2
  call void @__quantum__rt__array_reference(%Array* %arg0)
  %3 = getelementptr { %TupleHeader, %Array*, %Array*, %Array*, %Array* }, { %TupleHeader, %Array*, %Array*, %Array*, %Array* }* %1, i64 0, i32 2
  store %Array* %arg1, %Array** %3
  call void @__quantum__rt__array_reference(%Array* %arg1)
  %4 = getelementptr { %TupleHeader, %Array*, %Array*, %Array*, %Array* }, { %TupleHeader, %Array*, %Array*, %Array*, %Array* }* %1, i64 0, i32 3
  store %Array* %arg2, %Array** %4
  call void @__quantum__rt__array_reference(%Array* %arg2)
  %5 = getelementptr { %TupleHeader, %Array*, %Array*, %Array*, %Array* }, { %TupleHeader, %Array*, %Array*, %Array*, %Array* }* %1, i64 0, i32 4
...
entry:
  ...
  %2 = getelementptr { %TupleHeader, %Array*, %Array* }, { %TupleHeader, %Array*, %Array* }* %1, i64 0, i32 1
  store %Array* %arg0, %Array** %2
  call void @__quantum__rt__array_reference(%Array* %arg0)
  %3 = getelementptr { %TupleHeader, %Array*, %Array* }, { %TupleHeader, %Array*, %Array* }* %1, i64 0, i32 2
  store %Array* %arg1, %Array** %3
  call void @__quantum__rt__array_reference(%Array* %arg1)
...
entry:
  ...
  %2 = getelementptr { %TupleHeader, { %TupleHeader, double, double }*, %Array* }, { %TupleHeader, { %TupleHeader, double, double }*, %Array* }* %1, i64 0, i32 1
  ...
  %4 = getelementptr { %TupleHeader, { %TupleHeader, double, double }*, %Array* }, { %TupleHeader, { %TupleHeader, double, double }*, %Array* }* %1, i64 0, i32 2
...
entry:
  ...
  %2 = getelementptr { %TupleHeader, i64, { %TupleHeader, %Array*, %Array*, %Array*, %Array* }*, { %TupleHeader, i64, %Array* }*, double }, { %TupleHeader, i64, { %TupleHeader, %Array*, %Array*, %Array*, %Array* }*, { %TupleHeader, i64, %Array* }*, double }* %1, i64 0, i32 1
  store i64 %arg0, i64* %2
  %3 = getelementptr { %TupleHeader, i64, { %TupleHeader, %Array*, %Array*, %Array*, %Array* }*, { %TupleHeader, i64, %Array* }*, double }, { %TupleHeader, i64, { %TupleHeader, %Array*, %Array*, %Array*, %Array* }*, { %TupleHeader, i64, %Array* }*, double }* %1, i64 0, i32 2
  ...
  %5 = getelementptr { %TupleHeader, i64, { %TupleHeader, %Array*, %Array*, %Array*, %Array* }*, { %TupleHeader, i64, %Array* }*, double }, { %TupleHeader, i64, { %TupleHeader, %Array*, %Array*, %Array*, %Array* }*, { %TupleHeader, i64, %Array* }*, double }* %1, i64 0, i32 3
  ...
  %7 = getelementptr { %TupleHeader, i64, { %TupleHeader, %Array*, %Array*, %Array*, %Array* }*, { %TupleHeader, i64, %Array* }*, double }, { %TupleHeader, i64, { %TupleHeader, %Array*, %Array*, %Array*, %Array* }*, { %TupleHeader, i64, %Array* }*, double }* %1, i64 0, i32 4
...
entry:
  ...
  %0 = getelementptr { %TupleHeader, i64, %Array* }, { %TupleHeader, i64, %Array* }* %inputState, i64 0, i32 1
  %inputStateType = load i64, i64* %0
  %1 = getelementptr { %TupleHeader, i64, %Array* }, { %TupleHeader, i64, %Array* }* %inputState, i64 0, i32 2
  %inputStateTerms = load %Array*, %Array** %1
  %2 = getelementptr { %TupleHeader, %Array*, %Array*, %Array*, %Array* }, { %TupleHeader, %Array*, %Array*, %Array*, %Array* }* %hamiltonianTermList, i64 0, i32 1
  %ZData = load %Array*, %Array** %2
  %3 = getelementptr { %TupleHeader, %Array*, %Array*, %Array*, %Array* }, { %TupleHeader, %Array*, %Array*, %Array*, %Array* }* %hamiltonianTermList, i64 0, i32 2
  %ZZData = load %Array*, %Array** %3
  %4 = getelementptr { %TupleHeader, %Array*, %Array*, %Array*, %Array* }, { %TupleHeader, %Array*, %Array*, %Array*, %Array* }* %hamiltonianTermList, i64 0, i32 3
  %PQandPQQRData = load %Array*, %Array** %4
  %5 = getelementptr { %TupleHeader, %Array*, %Array*, %Array*, %Array* }, { %TupleHeader, %Array*, %Array*, %Array*, %Array* }* %hamiltonianTermList, i64 0, i32 4
...
body__2:                                          ; preds = %header__2
  ...
  %34 = getelementptr { %TupleHeader, %Array*, %Array* }, { %TupleHeader, %Array*, %Array* }* %hamiltonianTerm, i64 0, i32 1
  %qubitIndices = load %Array*, %Array** %34
  %35 = getelementptr { %TupleHeader, %Array*, %Array* }, { %TupleHeader, %Array*, %Array* }* %hamiltonianTerm, i64 0, i32 2
...
entry:
  %0 = getelementptr { %TupleHeader, i64, %Array* }, { %TupleHeader, i64, %Array* }* %stateData, i64 0, i32 1
  %stateType = load i64, i64* %0
  %1 = getelementptr { %TupleHeader, i64, %Array* }, { %TupleHeader, i64, %Array* }* %stateData, i64 0, i32 2
...
body__1:                                          ; preds = %header__1
  ...
  %8 = getelementptr { %TupleHeader, { %TupleHeader, double, double }*, %Array* }, { %TupleHeader, { %TupleHeader, double, double }*, %Array* }* %term, i64 0, i32 1
  %coefficient = load { %TupleHeader, double, double }*, { %TupleHeader, double, double }** %8
  %9 = getelementptr { %TupleHeader, { %TupleHeader, double, double }*, %Array* }, { %TupleHeader, { %TupleHeader, double, double }*, %Array* }* %term, i64 0, i32 2
  %excitation = load %Array*, %Array** %9
  %10 = getelementptr { %TupleHeader, double, double }, { %TupleHeader, double, double }* %coefficient, i64 0, i32 1
  %theta = load double, double* %10
  %11 = getelementptr { %TupleHeader, double, double }, { %TupleHeader, double, double }* %coefficient, i64 0, i32 2
