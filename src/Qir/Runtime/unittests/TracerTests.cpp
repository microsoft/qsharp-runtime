...
TEST_CASE("Layering distinct single-qubit operations of non-zero durations", "[tracer]")
{
    ...
    qubitid_t q1 = tr->AllocateQubit();
    qubitid_t q2 = tr->AllocateQubit();
    qubitid_t q3 = tr->AllocateQubit();
...
TEST_CASE("Layering distinct controlled single-qubit operations", "[tracer]")
{
    ...
    qubitid_t q2 = tr->AllocateQubit();
    qubitid_t q3 = tr->AllocateQubit();
    qubitid_t q4 = tr->AllocateQubit();
    qubitid_t q5 = tr->AllocateQubit();
    qubitid_t q6 = tr->AllocateQubit();
