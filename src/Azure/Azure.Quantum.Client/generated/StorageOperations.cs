...
namespace Microsoft.Quantum
{
    ...
    /// </summary>
    internal partial class StorageOperations : IServiceOperations<QuantumClient>, IStorageOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<SasUriResponse>> SasUriWithHttpMessagesAsync(BlobDetails blobDetails, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<SasUriResponse>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<SasUriResponse>(_responseContent, Client.DeserializationSettings);
                }
